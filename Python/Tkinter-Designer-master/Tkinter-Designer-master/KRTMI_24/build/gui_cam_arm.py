...
Mega = serial.Serial("COM6", 9600)

# Fungsi untuk membuka kamera
def open_camera():
    global camera_running, cap, Mega
...
def stop_program():
    global camera_running, Mega
    if Mega.is_open:
        Mega.close()

# Fungsi untuk retry
def retry_program():
    global turun, sedot, Arms
    turun = False
    sedot = False
    Arms = False
    Mega.open()
    print("Program diulang tanpa membuka kamera kembali.")
