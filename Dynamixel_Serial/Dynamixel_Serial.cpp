...
//	while((UCSR0A & B01100000) == B01100000){											// Wait for data to be transmitted with timeout counter ( Bit 6 – TXCn: USART Transmit Complete, Bit 5 – UDREn: USART Data Register Empty )
